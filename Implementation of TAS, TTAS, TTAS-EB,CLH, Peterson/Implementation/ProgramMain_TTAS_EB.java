...
public class ProgramMain_TTAS_EB{
	int numThreads;
	...
	public static void main(String[] args) {
		...
		ProgramMain_TTAS_EB pm = new ProgramMain_TTAS_EB();	
			...
			try{
				...
				System.out.print("\tAverage Execution time : " + ((double)total_time/10) + " milliseconds\n");
			}catch(Exception ex){}
	}
